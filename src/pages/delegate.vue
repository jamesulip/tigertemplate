  ...
  <div class="pt-3">
              ...
              <b-list-group class="list-group-flush">
                ...
                >
                  ...
                  <span
                    ...
                    v-b-tooltip.hover.bottom="des.name"
                    >{{ des.name }}</span
                  >
      ...
      <div class="col-md-9">
        <div class="card">
          ...
          <div class="card-body  p-0" style="min-height:600px">
            <table
              class="table table-hover table-head-fixed table-condensed table-sm  table-valign-middle"
            >
              <thead>
                <tr>
                  <th></th>
              ...
              <tbody>
                ...
                >
                  <td>
                    <b-form-checkbox
                      :id="`checkbox-${proj.ID}`"
                      v-model="proj.selected"
                      :name="`checkbox-${proj.ID}`"
                      :value="true"
                  ...
                  <td scope="row">
                    {{ proj.project.TYPE }}#{{ proj.project.NUM }}
                  </td>
                  ...
                  <td
                    class="align-middle text-truncate text-capitalize"
                    style="max-width: 100px;"
                  >
                    <div
                      v-if="proj.employees2"
                      v-b-tooltip.hover.bottom="
                        proj.employees2 ? proj.employees2.ln : 'Pending'
                      "
                      class="text-truncate"
                    >
                      <b-avatar
    ...
    <vue-context ref="menu" v-slot="{ data }">
      <template v-if="designers">
        <li
          @click.prevent="delegate(data, des)"
        ...
        <li @click="delegate(data, null)" class="bg-danger">
          <a> <b-icon-trash></b-icon-trash> Remove Delegation </a>
        </li>
      </template>
    </vue-context>
